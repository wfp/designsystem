...
###### Example
{% highlight html %}
<i class="thema-affected-population-pos"></i>
<i class="thema-affected-population-neg"></i>
{% endhighlight %}

###### Preview
<i class="thema-affected-population-pos"></i><i class="thema-affected-population-neg"></i>
