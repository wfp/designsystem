...
export const MusdCalc = props => {
  ...
  if (children) {
    ...
    valueb = valueb.toLocaleString('en-EN', {
      ...
      maximumFractionDigits:
        valueb <= 0.5 ? 5 : maximumFractionDigits ? maximumFractionDigits : 2,
    });
  }
...
export const Musd = props => {
  ...
  if (value) return <span className={props.className}>{value}</span>;
...
export const Level = props => {
  ...
  if (value) return <span className={props.className}>Level {value}</span>;
  else return <Invalid className={props.className} />;
};
...
export const LevelSvg = props => {
  ...
  return (
    <text className={props.className} {...other}>
      <tspan textAnchor={props.textAnchor} style={style}>
        Level {valueCalculated}
      </tspan>
    </text>
  );
};
...
export const Mt = props => {
  ...
  if (valueb) return <span className={props.className}>{valueb}</span>;
  else return <Invalid className={props.className} />;
};
...
export const MtSvg = props => {
  ...
  if (valueb) {
    ...
    return (
      <text className={props.className} {...other}>
        <tspan textAnchor="start" style={style}>
          {valueb}
        </tspan>
        <tspan style={style}> MT</tspan>
      </text>
    );
  } else return <InvalidSvg className={props.className} />;
};
...
export const PeopleSvg = props => {
  ...
  return (
    <text className={props.className} {...other}>
      ...
      <tspan style={style}> people</tspan>
    </text>
  );
};
...
/* Percentage 50 => 50% */
export const SimplePercentageCalc = (
  value,
  from,
  showZero,
  showUnit,
...
export const Percentage = props => {
  ...
  if (value !== false) return <span className={props.className}>{value}</span>;
  return <Invalid className={props.className} />;
};
...
export const PercentageSvg = props => {
  ...
  if (valueb !== false)
    return (
      <text dx={props.dx} dy={props.dy} className={props.className} {...other}>
        <tspan>{valueb}</tspan>
        <tspan> %</tspan>
      </text>
    );
...
export const Unit = props => {
  ...
  const unitClassName = props.type
    ...
    : '';
  const className =
    'wfp--unit ' + props.className + ' ' + unitClassName + ' ' + unitHideClass;
