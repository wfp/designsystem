...
describe('BannerNavigation', () => {
  describe('renders as expected', () => {
    const wrapper = shallow(
      <BannerNavigation>Items placed here</BannerNavigation>
    );
    ...
    describe('bannerWrapper', () => {
      ...
      it('renders default classes as expected', () => {
        expect(bannerWrapper().hasClass('wfp--banner-navigation')).toEqual(
          true
        );
      });
...
describe('BannerNavigationItem', () => {
  describe('renders as expected', () => {
    const wrapper = shallow(
      <BannerNavigationItem>Items placed here</BannerNavigationItem>
    );
