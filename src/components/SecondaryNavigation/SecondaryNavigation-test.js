...
describe('SecondaryNavigation', () => {
    describe('Renders as expected', () => {
        const wrapper = shallow(<SecondaryNavigation className="some-class" additional="additional Information">Content</SecondaryNavigation>)
        ...
        it('renders additional props as expected', () => {
            const additionalWrapper = mount(<SecondaryNavigation additional="additional Information">Content</SecondaryNavigation>)
