...
<List kind="bullet">
  <ListItem kind="checkmark">Internal and external applications</ListItem>
...
<List kind="bullet">
  <ListItem kind="cross">
    External websites (wfp.org, etc.): The header might not be the right
    solution for external websites. Please consult the #ux-ui channel on Slack.
  </ListItem>
  <ListItem kind="cross">
