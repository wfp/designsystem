...
describe('AuthLayout', () => {
  describe('renders as expected', () => {
    ...
    const backgroundWrapper = () =>
      wrapper.find('div.wfp--auth-background-wrapper');
    ...
    describe('backgroundWrapper', () => {
      ...
      it('renders classes as expected', () => {
        expect(
          backgroundWrapper().hasClass('wfp--auth-background-wrapper')
        ).toEqual(true);
      });
    });
    ...
    describe('contentWrapper', () => {
      ...
      it('renders classes as expected', () => {
        expect(contentWrapper().hasClass('wfp--auth-content-wrapper')).toEqual(
          true
        );
      });
    });
