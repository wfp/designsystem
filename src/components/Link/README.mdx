...
<List kind="bullet">
  ...
  <ListItem kind="checkmark">Links should be three words or less.</ListItem>
  <ListItem kind="checkmark">
  ...
  <ListItem kind="checkmark">
    Avoid the term “click here,” other links to “here,” or the web address
    itself. Instead, use a meaningful descriptive label for the link, and match
