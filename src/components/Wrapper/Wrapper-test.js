...
describe('ReadMore', () => {
  describe('Renders as expected', () => {
    const wrapper = shallow(<Wrapper className="some-class">Content</Wrapper>);
  ...
  describe('wrapper with background prop', () => {
    it('prop lighter should have class as expected', () => {
      ...
      expect(lightWrapper.hasClass('wfp--wrapper--background-lighter')).toEqual(
        true
      );
    });

    it('prop dark should have class as expected', () => {
      const darkWrapper = shallow(<Wrapper background="dark">Content</Wrapper>);
      expect(darkWrapper.hasClass('wfp--wrapper--background-dark')).toEqual(
        true
      );
    });
  });
  ...
  describe('wrapper with pageWidth prop', () => {
    it('should have class as expected', () => {
      const pageWrapper = shallow(<Wrapper pageWidth="lg">Content</Wrapper>);
  ...
  describe('wrapper with mobilePageWidth prop', () => {
    it('should have class as expected', () => {
      ...
      expect(mobileWrapper.hasClass('wfp--wrapper--width-mobile-full')).toEqual(
        true
      );
    });
  });
