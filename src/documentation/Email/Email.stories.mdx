...
<Meta
  title="Documentation/Guidelines/Email template"
...
<p>
  The eMail template can be used for application related notifications. It is
  responsive and works in Microsoft Outlook,{' '}
  <a
...
<p>
  Make sure to also provide a text-only version of your eMail and consider using
  a css inliner tool like{' '}
  <a
