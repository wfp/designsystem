...
<Meta
  title="Getting started/Getting started/Designers"
...
<p>
  ...
  library containing the core visual styles, components and patterns. All the
...
<h4>Sketch Cloud</h4>
<p>
  Use the Library on Sketch Cloud to always have access to the latest UI Kit.
</p>
<p>
...
<h4>Adobe xD</h4>
<p>
  Download the Adobe xD Template, unlike in Sketch it is not possible to use the
  template as a library.
</p>
<p>
