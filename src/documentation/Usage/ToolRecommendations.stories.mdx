...
<Meta
  title="Getting started/Getting started/Recommended tools"
...
<p>
  ...
  is a CSS pre-processor with syntax advancements and variable, functions, etc.{' '}
  <Link
    target="_blank"
...
<p>
  ...
  helps managing side effects when loading external data like link(asynchronous
  things)
</p>
...
<p>
  ...
  <Link onClick={linkTo('Design|Guidelines', 'Maps')}>Map guidelines</Link>.
</p>
{/*<p>
...
<p>
  <Link target="_blank" href="https://github.com/final-form/react-final-form">
    react-final-form
  </Link>{' '}
  is a form library for react.
</p>
<p style={{ textDecoration: 'line-through' }}>
  ...
  works with React Redux to enable an html form in React to use Redux to store
  all of its state.
</p>
...
<p>
  ...
  is a library which provides Azure Active Directory Library (ADAL) support for
  React
</p>
...
<h3>Charts</h3>
<p>
  <Link target="_blank" href="https://formidable.com/open-source/victory/">
    Victory
  </Link>{' '}
