...
storiesOf(' Documentation|Developers', module).add('React Usage', () => (
  <Page title="React Usage" subTitle="Guidelines & Recommendations">
    ...
    <h2>CSS</h2>
    <p>
      <Link href="https://sass-lang.com">scss/sass</Link> is a CSS pre-processor
      with syntax advancements and variable, functions, etc.{' '}
    ...
    <p>
      ...
      container for JavaScript apps. It helps you write applications that behave
      consistently, run in different environments (client, server, and native),
    ...
    <p>
      ...
      is a library which provides Azure Active Directory Library (ADAL) support
      for React
    </p>

    <h3>Tables</h3>
    <p>
      <Link href="https://github.com/react-tools/react-table">react-table</Link>{' '}
    ...
    <h3>Charts</h3>
    <p>
      <Link href="https://formidable.com/open-source/victory/">Victory</Link> is
      a set of modular charting components for React.
    </p>
