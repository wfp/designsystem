...
storiesOf(' Documentation', module)
  ...
  .addWithInfo('Naming Convention & Linting', ``, () => (
    ...
    <h3>Namespacing</h3>
    <p>
      The Components are built to be included individually and not clobber global styles - all class attributes are prefixed by the <i className="wfp--inline-highlight">wfp--</i> moniker.
    </p>
