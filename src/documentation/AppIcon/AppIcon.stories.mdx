...
<img
  ...
  src={`${process.env.STORYBOOK_ASSETS}appicons/latest/WFP_APP_ICON_300x300.png`}
/>
...
<div>
  {fileSizes.map((fileSize) => (
    <Link
      ...
      target="_blank"
      href={`${process.env.STORYBOOK_ASSETS}appicons/latest/WFP_APP_ICON_${fileSize}x${fileSize}.png`}>
