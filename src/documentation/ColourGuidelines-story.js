  ...
  .add('Colour guidelines', () => (
    <Page title="Colour guidelines" subTitle="Naming convention & linting">
      ...
      <List kind="bullet">
        ...
        <ListItem>Accent colours</ListItem>
        <ListItem>Neutrals</ListItem>
      ...
      <List kind="bullet">
        <ListItem>dark background</ListItem>
        <ListItem>MainNavigation</ListItem>
      ...
      <h3>brand - 01</h3>
      <p>Primary interactive colour, Primary buttons</p>
      <p>
      ...
      <h4>brand - 02</h4>
      <p>Interactive emphasis colour(e.g.hovers)</p>
      <p>
      ...
      <p>Semantic colours</p>
      <p>Success, error, warning and information</p>
      <h4>support - 01</h4>
      <p>Error</p>
