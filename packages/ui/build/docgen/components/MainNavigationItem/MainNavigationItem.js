...
var MainNavigationItem = /*#__PURE__*/function (_Component) {
  ...
  _createClass(MainNavigationItem, [{
    ...
    value: function render() {
      ...
      var wrapperClasses = (0, _classnames.default)(className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--main-navigation__item"), true), _defineProperty(_classNames, "".concat(prefix, "--main-navigation__item--open"), menuItem === activeMenuItem), _defineProperty(_classNames, "".concat(prefix, "--content-width"), subNavigation && subNavWideAsContent), _classNames));
      var triggerClasses = (0, _classnames.default)((_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefix, "--main-navigation__trigger"), true), _defineProperty(_classNames2, "".concat(prefix, "--main-navigation__trigger--has-sub"), subNavigation), _defineProperty(_classNames2, "".concat(prefix, "--main-navigation__trigger--open"), menuItem === activeMenuItem), _classNames2));
      var childrenWithProps = subNavigation ? /*#__PURE__*/_react.default.cloneElement(children, {
        children: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, children.props.children, /*#__PURE__*/_react.default.createElement(_Icon.default, {
          className: "".concat(prefix, "--main-navigation__trigger__icon"),
          icon: menuItem === activeMenuItem ? _icons.iconClose : _icons.iconCaretDown,
          fill: "#FFFFFF",
      ...
      var subClasses = (0, _classnames.default)((_classNames3 = {}, _defineProperty(_classNames3, "".concat(prefix, "--main-navigation__sub"), true), _defineProperty(_classNames3, "".concat(prefix, "--main-navigation__sub--open"), menuItem === activeMenuItem), _classNames3));
      return /*#__PURE__*/_react.default.createElement("li", {
        className: wrapperClasses,
        ref: this.setWrapperRef
      }, /*#__PURE__*/_react.default.createElement("div", {
        className: triggerClasses
      }, childrenWithProps), subNavigation && /*#__PURE__*/_react.default.createElement("div", {
...
MainNavigationItem.propTypes = {
   ...
   */
  subNavigation: _propTypes.default.node
};
var _default = MainNavigationItem;
