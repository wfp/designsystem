...
var props = {
  select: function select() {
    return {
      ...
      small: (0, _addonKnobs.boolean)('Styling for small (small)', false),
...
(0, _react2.storiesOf)('Components|Select', module).addDecorator(_addonKnobs.withKnobs).add('Default', function () {
