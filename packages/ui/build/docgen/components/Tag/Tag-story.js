...
(0, _react2.storiesOf)('Components|Tag', module).addDecorator(_addonKnobs.withKnobs).add('Default', function () {
  return /*#__PURE__*/_react.default.createElement(_Tag.default, {
    className: "some-class",
    type: (0, _addonKnobs.select)('Tag type (type)', types, 'wfp')
  }, (0, _addonKnobs.text)('Content (children)', 'This is a tag'));
}).add('skeleton', function () {
  return /*#__PURE__*/_react.default.createElement(_Tag2.default, null);
});