...
describe('Loading', function () {
  describe('Renders as expected', function () {
    ...
    var overlay = wrapper.find('.wfp--loading-overlay');
    var loader = wrapper.find('.wfp--loading');
  ...
  describe('Sets props and state as expected', function () {
    ...
    it('should remove and add wfp--loading--stop class', function () {
      wrapper.setProps({
        active: false
      });
      expect(wrapper.find('.wfp--loading').hasClass('wfp--loading--stop')).toEqual(true);
      wrapper.setProps({
        active: true
      });
      expect(wrapper.find('.wfp--loading').hasClass('wfp--loading--stop')).toEqual(false);
    });
