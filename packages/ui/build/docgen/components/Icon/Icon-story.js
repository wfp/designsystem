...
var iconMap = {
  iconAdd: _icons.iconAdd,
  iconAddGlyph: _icons.iconAddGlyph,
  iconAddOutline: _icons.iconAddOutline
};

var customIcon = /*#__PURE__*/_react.default.createElement("svg", {
  width: "50",
  height: "50",
  viewBox: "0 0 50 50",
...
var props = {
  default: function _default() {
    var selectedIcon = (0, _addonKnobs.select)('The icon (icon (regular))', icons, 'iconAdd');
    return {
      style: {
        margin: '50px'
      },
...
(0, _react2.storiesOf)('Components|Icon', module).addDecorator(_addonKnobs.withKnobs).add('Default', function () {
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_Icon.default, props.default()));
}).add('Custom Icon (experimental)', function () {
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_Icon.default, props.custom()));
