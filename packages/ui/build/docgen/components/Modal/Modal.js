...
var Modal = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      }, passiveModal && modalButton, /*#__PURE__*/_react.default.createElement("div", null, modalLabel && /*#__PURE__*/_react.default.createElement("h4", {
      ...
      }, modalHeading)), modalSecondaryAction && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, modalSecondaryAction), !passiveModal && modalButton), /*#__PURE__*/_react.default.createElement("div", {
        className: "".concat(prefix, "--modal-content")
      }, this.props.children), !passiveModal && /*#__PURE__*/_react.default.createElement("div", {
        className: "".concat(prefix, "--modal-footer")
      }, !modalFooter ? /*#__PURE__*/_react.default.createElement("div", {
      ...
      }, primaryButtonText)) : /*#__PURE__*/_react.default.createElement("div", null, modalFooter(this.props))));

      var modal = /*#__PURE__*/_react.default.createElement("div", _extends({}, other, {
      ...
      if (inPortal) {
        return /*#__PURE__*/_reactDom.default.createPortal(modal, this.el);
      } else {
        return modal;
      }
    }
...
_defineProperty(Modal, "propTypes", {
   ...
   */
  modalFooter: _propTypes.default.func,
   ...
   */
  selectorPrimaryFocus: _propTypes.default.oneOfType([_propTypes.default.bool, _propTypes.default.string]),

  /**
   *  Different styling options are available `info`, `warning`, `danger`
   */
  type: _propTypes.default.oneOf(['info', 'warning', 'danger']),

  /**
   * If true the Modal will be rendered inside a portal at the end of the
   * body element, otherwise at the position it is placed.
   */
  inPortal: _propTypes.default.bool,
