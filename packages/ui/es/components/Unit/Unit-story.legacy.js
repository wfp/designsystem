...
import { withKnobs, select, text, number } from '@storybook/addon-knobs/react'; // const units = [
//   {
...
storiesOf('Components|Unit', module).addDecorator(withKnobs).addParameters({
  jest: ['Unit-test']
})
/*.add('Samples', () => {
  const columns = [
...
.add('default', function () {
  ...
  var value = text('value', 1000000);
  return /*#__PURE__*/React.createElement(Unit, unitProps, value);
});