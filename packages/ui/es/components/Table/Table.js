...
export default function Table(_ref) {
  ...
  var classes = classNames("".concat(prefix, "--table"), (_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--table--responsive"), responsive), _defineProperty(_classNames, "".concat(prefix, "--table--with-border"), withBorder), _classNames), className);
  return /*#__PURE__*/React.createElement("table", _extends({}, other, {
    className: classes
  }), children);
}
Table.propTypes = {
