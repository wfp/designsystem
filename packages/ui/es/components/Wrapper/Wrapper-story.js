...
storiesOf('Components|Wrapper', module) //.addDecorator(withSmartKnobs)
.addDecorator(withKnobs).add('Default', function () {
  ...
  var defaultValue = 'sm';
  var pageWidth = select('pageWidth', options, defaultValue);
  var optionsMobilePageWidth = {
    '': 'undefined',
    full: 'full'
  };
  var mobilePageWidth = select('mobilePageWidth', optionsMobilePageWidth, defaultValue);
  var optionsSpacing = {
    '': 'undefined',
    md: 'md',
    xl: 'xl'
  };
  var spacing = select('spacing', optionsSpacing, defaultValue);
