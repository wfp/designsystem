...
describe('Slider', function () {
  ...
  describe('Supporting label', function () {
    it('concatenates the value and the label by default', function () {
      ...
      expect(wrapper.find('.wfp--slider__range-label').first().text()).toBe('0min');
      expect(wrapper.find('.wfp--slider__range-label').last().text()).toBe('100max');
    });
    it('supports custom formatting of the label', function () {
      ...
      expect(wrapper.find('.wfp--slider__range-label').first().text()).toBe('0-min');
      expect(wrapper.find('.wfp--slider__range-label').last().text()).toBe('100-max');
    });
  });
...
describe('SliderSkeleton', function () {
  describe('Renders as expected', function () {
    ...
    var slider = wrapper.find('.wfp--slider-container');
    it('Has the expected classes', function () {
