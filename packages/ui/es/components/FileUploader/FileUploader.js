...
import { iconCheckmarkGlyph, iconCloseGlyph, iconWarningGlyph } from '@wfp/icons';
...
export var FileUploaderButton = /*#__PURE__*/function (_Component) {
  ...
  _createClass(FileUploaderButton, [{
    ...
    value: function render() {
      ...
      var classes = classNames("".concat(prefix, "--btn"), className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--btn--").concat(buttonKind), buttonKind), _defineProperty(_classNames, "".concat(prefix, "--btn--disabled"), disabled), _classNames));
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("label", _extends({
        ...
        role: role
      }, this.state.labelText)), /*#__PURE__*/React.createElement("input", {
...
export function Filename(_ref2) {
  ...
  switch (status) {
    ...
    case 'edit':
      return /*#__PURE__*/React.createElement(React.Fragment, null, invalid && /*#__PURE__*/React.createElement(Icon, {
