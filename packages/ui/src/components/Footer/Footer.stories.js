...
socialIcons={
  <>
  <li className={`wfp--footer-ext__social-icon`}>
    <a
...
>
<div className={`wfp--links-column`}>
      {/* Title is optional */}
      <p className={`wfp--links-column__title`}>Title</p>
      <nav>
        <ul className={`wfp--links-column__nav-list`}>
