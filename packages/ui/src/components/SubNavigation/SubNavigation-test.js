...
import {SubNavigation, SubNavigationHeader,SubNavigationTitle,
    SubNavigationLink, SubNavigationFilter,SubNavigationContent,
    SubNavigationList, SubNavigationGroup,SubNavigationItem} from './SubNavigation';
...
describe('SubNavigation', () => {
    ...
    describe('renders subnavigationItem as expected', ()=>{
        const itemWrapper = shallow(<SubNavigationItem className="some-class">contentItem</SubNavigationItem>)
    ...
    describe('renders subnavigationHeader as expected', ()=>{
        const headerWrapper = shallow(<SubNavigationHeader className="some-class">NavHeader</SubNavigationHeader>)
    ...
    describe('renders subnavigationFilter as expected', ()=>{
        const filterWrapper = shallow(<SubNavigationFilter className="some-class">Navfilter</SubNavigationFilter>)
    ...
    describe('renders SubNavigationList as expected', ()=>{
        const ListWrapper = shallow(<SubNavigationList className="some-class">NavList</SubNavigationList>)
    ...
    describe('renders SubNavigationContent as expected', ()=>{
        const contentWrapper = shallow(<SubNavigationContent className="some-class">NavContent</SubNavigationContent>)
    ...
    describe('renders SubNavigationTitle as expected', ()=>{
        const titleWrapper = shallow(<SubNavigationTitle className="some-class">Navtitle</SubNavigationTitle>)
    ...
    describe('renders SubNavigationLink as expected', ()=>{
        const linkWrapper = shallow(<SubNavigationLink className="some-class">NavLink</SubNavigationLink>)
    ...
    describe('renders SubNavigationGroup as expected', ()=>{
        const groupWrapper = mount(<SubNavigationGroup columns={3} className="some-class" title="Group title">NavGroup</SubNavigationGroup>)
