...
declare type HeroKind = 'landscape'
  | 'landscape-light'
  | 'emergencies'
  | 'split'
  | 'hero'
...
declare type NotificationKind =  'error'
 | 'success'
 | 'warning'
 | 'warning-alt'
 | 'info'
