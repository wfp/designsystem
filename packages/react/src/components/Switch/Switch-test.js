...
describe('Switch', () => {
  describe('component rendering', () => {
    ...
    it('icon should have the expected class', () => {
      const cls = 'wfp--content-switcher__icon';
    ...
    it('should have the expected class', () => {
      const cls = 'wfp--content-switcher-btn';
    ...
    it('should not have selected class', () => {
      const selectedClass = 'wfp--content-switcher--selected';
    ...
    it('should have a selected class when selected is set to true', () => {
      ...
      expect(buttonWrapper.hasClass('wfp--content-switcher--selected')).toEqual(
        true
      );
      expect(linkWrapper.hasClass('wfp--content-switcher--selected')).toEqual(
        true
      );
    });
  });
