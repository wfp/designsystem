...
| Logo            | `Vertical black english Logo from @un/icons` | `string`              | Footer Logo on Mobile Devices, if not set the default logo from `@un/icons` be used.                 |
| Logo            | `Extended black english from @un/icons`      | `string`              | Footer on Desktop Devices, if not set the default logo from `@un/icons` be used.                     |
