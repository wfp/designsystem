...
<!--
```js
import { Footer } from '@unitednations/react';
```
...
| Logo            | `Vertical black english Logo from @unitednations/icons` | `string`              | Footer Logo on Mobile Devices, if not set the default logo from `@unitednations/icons` be used.                 |
| Logo            | `Extended black english from @unitednations/icons`      | `string`              | Footer on Desktop Devices, if not set the default logo from `@unitednations/icons` be used.                     |
