...
import colors from '@unitednations/ui/src/globals/data/colors.json'

// Import colours as js
import colors from '@unitednations/ui/src/globals/data/colors.js'
...
`}
      ...
      <Blockquote title="Usage in scss" code>
        <PrismCode component="pre" className="language-css">
          {`// Only use variables
@import "~@unitednations/ui/src/globals/scss/vars";
