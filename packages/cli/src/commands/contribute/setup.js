...
async function setup() {
  console.log(chalk`
{bold Hi there!} 👋
This tools is built for people looking to contribute to wfp.`);
...
`);
  ...
  console.log('Done! 🥳  Thanks so much for contributing to WFP! 🙏');
}
...
an issue over at:
{link https://github.com/wfp-design-system/wfp/issues/new/choose}`
      );
    }
  };
}
...
const availableProjects = [
  ...
  {
    name: 'gatsby-theme-wfp',
    value: {
      owner: 'wfp-design-system',
      repo: 'gatsby-theme-wfp',
