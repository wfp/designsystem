...
async function check(args, env) {
  ...
  const tasks = [
    `yarn wfp-cli check --ignore '**/@(node_modules|examples|components|react|fixtures|compat)/**' 'packages/**/*.scss'`,
    ...
    `cross-env PERCY_TOKEN=dd3392142006a6483c8f524697f39f052755fa9dc087ff4437cac3d64227abdd yarn run percy exec -- yarn workspace wfp-components-react test:e2e`,
  ];
